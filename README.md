...
This repository contains the data and source code required to reproduce the results reported in **[TODO: Paper Title Here]**. The project focuses on the structural analysis, pathogenicity prediction, and stability assessment of STK3 variants.
